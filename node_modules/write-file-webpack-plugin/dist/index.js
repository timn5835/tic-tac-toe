...
exports.default = function () {
  ...
  const log = function () {
    ...
    console.log(_chalk2.default.dim('[' + (0, _moment2.default)().format('HH:mm:ss') + '] [write-file-webpack-plugin]'), ...append);
  };
  ...
  const apply = compiler => {
    ...
    const setup = () => {
      ...
      if (!outputPath) {
        if (!_lodash2.default.has(compiler, 'options.devServer.outputPath')) {
